  ...
  return (
    <div
      ...
      style={{
        ...
        transition:
          "background 0.22s, border-color 0.22s, transform 0.2s, box-shadow 0.22s",
  ...
  return (
    ...
    >
      ...
      <div style={{ position: "relative", zIndex: 1, maxWidth: "65%" }}>
        ...
        >
          Welcome back, {first}! Let's report violations and make roads safer
          today.
        </h2>
        <p
          style={{
        ...
        >
          Every report you file brings us one step closer to safer roads for
          everyone.
        </p>
      </div>
    </div>
