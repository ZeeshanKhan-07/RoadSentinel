  ...
  return (
    <div className="w-full max-w-sm mx-auto">
      <style>{`
        ...
        .rs-btn-primary:hover:not(:disabled) { background: #e8e8e8; padding:14px; font-size: 15px}
      ...
      {/* Brand tag */}
      <p className="font-display uppercase text-white text-center mb-5">
        Road Sentinel
      </p>

      <h2 className="font-display text-white mb-1">Welcome back</h2>
      <p
        style={{
          font: "'grotesk'",
          fontSize: "13px",
      ...
      >
        <div>
          <label className="block font-display text-[12px] font-medium text-white/45 mb-1 tracking-[0.04em] pl-1">
            Email
          </label>
          <input
            className="rs-input text-grotesk"
            type="email"
            name="email"
        ...
        <button
          className="rs-btn-primary font-display"
          type="submit"
          disabled={loading}
          style={{ marginTop: "6px" }}
        >
      ...
      <div className="rs-divider">
        ...
        <span className="rs-divider-text font-display">OR CONTINUE WITH</span>
        <div className="rs-divider-line" />
      </div>

      {/* Google OAuth Button */}
      <button
        className="rs-btn-google"
